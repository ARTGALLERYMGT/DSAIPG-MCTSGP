...
import static com.phasmidsoftware.dsaipg.util.benchmark.SortBenchmarkHelper.generateRandomLocalDateTimeArray;
...
public class SortBenchmark {
    ...
    void benchmarkStringSorters(String[] words, int nWords) {
        ...
        // logger.info("CONFIG CHECK: LSD=" + isConfigBenchmarkStringSorter("LSD") + ", nRunsLinear=" + nRunsLinear);
        // logger.info("CONFIG CHECK: MSD=" + isConfigBenchmarkStringSorter("MSD") + ", nRunsLinear=" + nRunsLinear);
        // logger.info("CONFIG CHECK: mergesort=" + isConfigBenchmarkStringSorter("MERGESORT") + ", nRunsLinearithmic=" + nRunsLinearithmic);
        // logger.info("CONFIG CHECK: heapsort=" + isConfigBenchmarkStringSorter("heapsort") + ", nRunsLinearithmic=" + nRunsLinearithmic);
        // logger.info("CONFIG CHECK: introsort=" + isConfigBenchmarkStringSorter("introsort") + ", nRunsLinearithmic=" + nRunsLinearithmic);
        // logger.info("CONFIG CHECK: insertionsort=" + isConfigBenchmarkStringSorter("insertionsort"));
        // logger.info("CONFIG CHECK: insertionsortopt=" + isConfigBenchmarkStringSorter("insertionsortopt"));
        // logger.info("CONFIG CHECK: bubblesort=" + isConfigBenchmarkStringSorter("bubblesort"));
...
//            }
    ...
    public SortBenchmark(Config config) {
        ...
        System.out.println(" DEBUG: Checking loaded config values from [benchmarkstringsorters] section:");
        
        String[] keys = {
            "quicksort", "quicksort3way", "quicksortDualPivot", "mergesort",
            "heapsort", "introsort", "insertionsort", "insertionsortopt",
            "bubblesort", "shellsort", "timsort", "randomsort", "bucketsort",
            "LSD", "MSD", "puresystemsort"
        };
    
        for (String key : keys) {
            try {
                boolean value = config.getBoolean("benchmarkstringsorters", key);
                System.out.println("Config [" + key + "] = " + value);
            } catch (Exception e) {
                System.out.println("Config [" + key + "] = ERROR (" + e.getMessage() + ")");
            }
        }
    }
